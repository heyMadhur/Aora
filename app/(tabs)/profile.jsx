...
import { getAllPosts, getLatestPost, getUserPosts, searchPosts, signOut } from '../../lib/appwrite'
...
const Profile = () => {
  ...
  const logout = async() => { 
    ...
    // We have replaced the whole route so that user cant go back to previous screen, once he logged out
